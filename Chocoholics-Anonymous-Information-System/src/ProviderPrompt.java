...
public class ProviderPrompt extends Prompter {
    ...
    public void run() {
        ...
        Provider thisProvider = ChocAnApplication.providerDatabase.getEntry(Integer.parseInt(id));
        ...
        while (!choice.equals("4")) {
            ...
            switch (choice) {
                case "1":
                    ...
                    ArrayList<Service> services = ChocAnApplication.providerDirectoryDatabase.getEntryList();
                ...
                case "2":
                    ...
                    Member thisMember = ChocAnApplication.memberDatabase.getEntry(Integer.parseInt(memberId));
                    if (thisMember == null) {
                    ...
                    Service thisService = ChocAnApplication.providerDirectoryDatabase.getEntry(serviceId);
                    if (thisService == null) {
                    ...
                    ChocAnApplication.providedServiceDatabase.addEntry(pS);
