...
public class MemberReport extends Report {
    ...
    public void generateReport() throws IOException {
        ...
        try{
            ...
            ArrayList<ProvidedService> allServices =  ChocAnApplication.providedServiceDatabase.getEntryList();
            for (int i = 0; i < allServices.size(); ++i) {
                ...
                if (s.getMemberId() == thisMemberId) {
                    ...
                    Provider provider = ChocAnApplication.providerDatabase.getEntry(s.getProviderId());
                    fW.write("Provider name: " + provider.getName() + newLine);

                    //Get the service provided
                    Service service = ChocAnApplication.providerDirectoryDatabase.getEntry(s.getServiceId());
